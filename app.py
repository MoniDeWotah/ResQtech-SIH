...
# 🔑 Gemini API Key
GEMINI_API_KEY = os.environ.get("GEMINI_API_KEY", "AIzaSyDBfs90kg1YdPREvlzuie_I0cRxiQBbAz0")
...
def prediction_page():
    # The JS in prediction.html will read student_id from query param
...
def api_predict(student_id):
    ...
    ai_insight = "AI insights unavailable (Gemini key not set)."
    if GEMINI_API_KEY != "AIzaSyDBfs90kg1YdPREvlzuie_I0cRxiQBbAz0":
        prompt = f"""
        ...
        try:
            ...
            ai_insight = f"AI insight error: {e}"
